...
import { CERTIFICATIONS, SKILLS, EDUCATION, ICON_MAP } from './constants';
...
const App: React.FC = () => {
  ...
  // Profile photo - Using the LinkedIn profile link provided for the professional headshot.
      ...
      <nav className={`fixed top-0 w-full z-50 backdrop-blur-md border-b transition-colors duration-300 ${isDark ? 'bg-[#0B0E14]/80 border-gray-800' : 'bg-white/80 border-slate-200'}`}>
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 font-medium">
            <a href="#about" className="hover:text-[#2E5BFF] transition-colors">About</a>
            <a href="#experience" className="hover:text-[#2E5BFF] transition-colors">Experience</a>
            <a href="#credentials" className="hover:text-[#2E5BFF] transition-colors">Credentials</a>
            <a href="#skills" className="hover:text-[#2E5BFF] transition-colors">Skills</a>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 reveal">
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
              <a href="#contact" className={`px-8 py-4 rounded-xl font-bold transition-all transform hover:scale-105 ${isDark ? 'bg-[#2E5BFF] hover:bg-[#1e44cc] text-white shadow-lg glow-blue' : 'bg-[#2E5BFF] hover:bg-[#1e44cc] text-white shadow-lg'}`}>
                Connect With Me
              </a>
